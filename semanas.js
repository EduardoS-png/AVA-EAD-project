document.addEventListener('DOMContentLoaded', function() {
    ...
    const courses = [
        { id: 1, name: "Semana 1", active: true },
        { id: 2, name: "Semana 2", active: false },
        { id: 3, name: "Semana 3", active: false },
        { id: 4, name: "Semana 4", active: false },
        { id: 5, name: "Semana 5", active: false },
        { id: 6, name: "Semana 6", active: false },
        { id: 7, name: "Semana 7", active: false },
        { id: 8, name: "Semana 8", active: false },
    ];
